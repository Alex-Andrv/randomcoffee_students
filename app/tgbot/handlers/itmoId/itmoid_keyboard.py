...
def get_itmoid_keyboard(user_id):
    offer_oauth_registrate_button = InlineKeyboardButton(
        ...
        url=f'https://id.itmo.ru/auth/realms/itmo/protocol/openid-connect/auth?client_id=itmoffe-bot&response_type=code&scope=openid profile email&redirect_uri=https://rcoffeestudent.itmo.ru&state={user_id}')
